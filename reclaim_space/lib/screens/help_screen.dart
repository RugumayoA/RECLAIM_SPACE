        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 12),
              Text('Q: How do I contact support?\nA: Email info.groupg.aits@gmail.com or call 0200905814.', style: TextStyle(color: Colors.white70, fontSize: 16)),
              SizedBox(height: 12),
              Text('Q: How do I delete my account?\nA: Go to Settings > Delete Account.', style: TextStyle(color: Colors.white70, fontSize: 16)),
              SizedBox(height: 24),
              Text('For more help, contact us at info.groupg.aits@gmail.com or call 0200905814.', style: TextStyle(color: Colors.white54, fontSize: 15)),
            ],
          ),
        ),
      ),
